...
Public Class rptMemberReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "I_And_Sport_Club.rptMemberReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CountMember() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMemberReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMemberReport = New rptMemberReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
