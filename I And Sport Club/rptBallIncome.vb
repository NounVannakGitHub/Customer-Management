...
Public Class rptBallIncome
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "I_And_Sport_Club.rptBallIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBallIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBallIncome = New rptBallIncome()
        rpt.Site = Me.Site
        Return rpt
    End Function
