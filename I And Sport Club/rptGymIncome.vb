...
Public Class rptGymIncome
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "I_And_Sport_Club.rptGymIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGymIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGymIncome = New rptGymIncome()
        rpt.Site = Me.Site
        Return rpt
    End Function
